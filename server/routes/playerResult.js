...
router.get('/:playerResultId/answers', verifyToken, async (req, res) => {
...
router.patch('/:playerResultId/answers', verifyToken, async (req, res) => {
	const { playerResultId } = req.params
  const { questionIndex, 
    // answered, 
...
router.get('/:playerResultId/answers/:answerId', verifyToken, async (req, res) => {
...
router.patch('/:playerResultId/answers/:answerId', verifyToken, async (req, res) => {
  const { playerResultId, answerId } = req.params
...
router.delete('/:playerResultId/answers/:answerId', verifyToken, async (req, res) => {
  if (!mongoose.Types.ObjectId.isValid(playerResultId)) {
